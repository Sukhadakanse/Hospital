...
%>
		...
		<center>
			<div style="position:absolute;left:0;top: 100px;width: 1270px;">
<%
		try
			{
...
%>
					<table cellspacing="0" cellpadding="5" border="1px" style="height: 80%;font-family: cosmic sans ms;font-size: 20px;text-align: center;">
